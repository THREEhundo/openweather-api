import locationPane from './location-pane.js'
...
function callCity(city) {
	...
	console.log(hour, minutes, month, day, year)
	localeTime.innerHTML = `${hour}:${minutes}:${seconds}`
	const currDate = document.createElement('div')
	currDate.id = 'date'
	currDate.innerHTML = `${month}/${day}/${year}`
	...
	desc.id = 'desc'
	desc.innerHTML = `${city.description.toUpperCase()}`
	...
	description.appendChild(currDate)
